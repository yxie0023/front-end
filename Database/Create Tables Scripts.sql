...
CREATE TABLE `total-number-of-deaths-by-cause` (
  `Entity` text,
  `Code` text,
  `Year` text,
  `Deaths - Non-communicable diseases` text,
  `Deaths - Communicable-maternal-neonatal-nutritional diseases` text,
  `Deaths - Injuries` text
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `trust-healthcare-vs-vaccine-safety` (
  `Entity` text,
  `Code` text,
